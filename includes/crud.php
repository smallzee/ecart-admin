...
define('DOMAIN_URL', 'http://freelance.io/projects/ecart'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'authentication'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_name = "fpe_app_ecart";    // Change as required
