...
$order_data = array('user_msg' => "hello you new order",'otp_msg' => "here is your otp",'otp' => 123456,'total_amount' => 'Rs6000.0','delivery_charge' => 'Rs20.0','tax_amount' => 'Rs10','discount' => '10(%)','wallet_used' => 'Rs00','final_total' => 'Rs5090','payment_method' => 'COD','address' => 'bhuj');
...
<body style="width:100%;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
    ...
    color: #8c8d8e;
">
    <small><i>* prices are shown including taxes. </i></small></div>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="right" style="Margin:0;padding-right:10px;padding-top:15px;padding-bottom:15px;padding-left:40px">
                                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation">
                                                                        <tr style="border-collapse:collapse">
                                                                            <td width="80%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif"><b>Tax Amount (5%)</b></h4>
                                                                            </td>
                                                                            <td width="20%" style="padding:0;Margin:0">
                                                                                <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?= $order_data['tax_amount'] ?></h4>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
